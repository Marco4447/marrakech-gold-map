...
export const RecoveryEmail = ({
  ...
  <Html lang="fr" dir="ltr">
    <Head />
    <Preview>Réinitialisez votre mot de passe Weshkech</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Pas de panique ! Cliquez sur le bouton ci-dessous pour choisir un
          nouveau mot de passe pour votre compte Weshkech.
        </Text>
