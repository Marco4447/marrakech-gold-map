...
const SuperVibeParticles = forwardRef<HTMLDivElement, SuperVibeParticlesProps>(
...
SuperVibeParticles.displayName = "SuperVibeParticles";

export default SuperVibeParticles;
