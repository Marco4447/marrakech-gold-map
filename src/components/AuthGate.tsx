...
export default function AuthGate() {
  ...
  const handleResend = async () => {
    ...
    setError("Code renvoyé ! Vérifie ta boîte 📩");
    setLoading(false);
  };
    ...
    <div className="fixed inset-0 z-[9999] bg-background flex flex-col items-center justify-center overflow-hidden">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground mb-8 leading-relaxed max-w-[280px]">
          Crée ton compte pour liker, poster et profiter des avantages exclusifs.
        </p>
          ...
          {step === "oauth-error" ? (
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-foreground text-background font-bold py-4 rounded-2xl transition-all disabled:opacity-70 text-[15px] active:scale-[0.98] shadow-lg"
              >
                {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : "Valider le code ✓"}
              </button>
